        ...
        docs: {
          ...
          editUrl: ({ locale, versionDocsDirPath, docPath }) => {
            ...
            if (locale !== 'en') {
              ...
              return `https://github.com/AlayaNetwork/alaya-devdocs/tree/main/website/i18n/${locale}/docusaurus-plugin-content-docs/current/${docPath}`
            }
            // Github 的英文文档链接
            return `https://github.com/AlayaNetwork/alaya-devdocs/tree/main/website/docs/${docPath}`
          }
        },
        blog: false,
        theme: {
