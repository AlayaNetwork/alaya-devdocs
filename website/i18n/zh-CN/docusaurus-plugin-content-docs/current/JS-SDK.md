...
batch.add(web3.platon.getBalance.request('atx1w9x7ye4qalarnl9v59zzhyn7tug9864rll39n7', 'latest', callback))
batch.add(
  contract.methods.balance(address).call.request({ from: 'atx1w9x7ye4qalarnl9v59zzhyn7tug9864rll39n7' }, callback2)
)
batch.execute()
```
