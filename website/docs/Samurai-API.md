...
#### **Alaya JSON-RPC method**

For information about Alaya JSON-RPC API, please refer to [Alaya-DevDocs](https://devdocs.alaya.network/alaya-devdocs/en/Json_Rpc).
