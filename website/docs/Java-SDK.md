...
- **Proposal**: Objects that hold information about a single proposal
  ...
  - BigInteger: activeBlock(if the vote passes) the effective block height(endVotingBlock + 20 + 4 _ 250<effective block height<= endVotingBlock + 20 + 10 _ 250)
  - String: verifier
...
- Generate Java wrapper classes via command line tools（[platon-web3j download](https://download.alaya.network/alaya/sdk/0.16.0/alaya-web3j-0.16.0.0.zip)）:
