...
On the online machine, copy the link <https://download.alaya.network/alaya/mtool/windows/0.16.2/mtool-setup.exe> ​​to the browser to download the MTool installation package.
