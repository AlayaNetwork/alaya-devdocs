...
> - When  the prompt shows "Please enter the delegatedRewardRate(0~10000):", please enter the proportion of dividends, ranging from 0 to 10000, in units (ten thousandths of a percentage). For example, if you enter 6000, indicates that the reward proportion allocated to the entrusting party is 60%.
