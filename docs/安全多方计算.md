...
![](/alaya-devdocs/img/en/MPC.assets/1_out_of_2_ot-en.png)
...
![](/alaya-devdocs/img/en/MPC.assets/function_to_boolean_circuit.png)
...
![](/alaya-devdocs/img/en/MPC.assets/gates_to_true_false_table.jpg)
...
![](/alaya-devdocs/img/en/MPC.assets/label_to_true_false_table_values.png)
...
![](/alaya-devdocs/img/en/MPC.assets/choose_random_replace_0_1.jpg)
...
![](/alaya-devdocs/img/en/MPC.assets/use_input_wire_label_encrypt_output_wire.jpg)
...
![](/alaya-devdocs/img/en/MPC.assets/gates_decrypt_output_label.jpg)
...
![](/alaya-devdocs/img/en/MPC.assets/MPC-basic-flow-en.png)
...
![](/alaya-devdocs/img/en/MPC.assets/Alaya_two_parties_infrastructure-en.png)
